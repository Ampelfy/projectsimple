        ...
        <div class="popup__content">
            <div class="popup__body">
                ...
                <form class="row g-3 needs-validation" novalidate="">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control phone" id="validationCustom02" placeholder="Phone number"
                               required="">
                    </div>
                    <div class="col-md-12">
        ...
        <div class="menu">
            ...
            <ul class="menu__list">
                <?php foreach ( $menu as $item ) : ?>
                    <li class="menu__item">
                        <a href="<?php echo $item->url; ?>" class="menu__link _popup-link"><?php echo $item->post_title; ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
            <?php endif; ?>
            ...
            <ul class="menumobile__list">
                <div class="list-top">
	                <?php if ( !empty( $menu ) ) : ?>
		                <?php foreach ( $menu as $item ) : ?>
                            <li class="menu__item">
                                <a href="<?php echo $item->url; ?>" class="btnsmall btnsmall_nobg menu__link _popup-link"><?php echo $item->post_title; ?></a>
                            </li>
		                <?php endforeach; ?>
	                <?php endif; ?>
                </div>
            ...
            <ul class="auth__list">
                ...
                <li class="auth__item auth__item-signup">
                    <a href="<?php echo $signup_link; ?>"
                       class="btnsmall btnsmall_white"><?php _e( 'Sign Up', 'landing' ); ?></a>
                </li>
            </ul>
        </div>
    </div>
