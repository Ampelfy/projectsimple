...
$mobile_demo_button_title = get_field( 'mobile_demo_button_title' );
$mobile_demo_button_link = get_field( 'mobile_demo_button_link' );
...
?>
	...
	<main class="page">
			...
			<div class="container">
				<div class="firstview__top">
					...
					<div class="buttons">
                        ...
                        <a id="demo" href="<?php echo $mobile_demo_button_link; ?>" class="btnxl btnxl_blue _popup-link"><?php echo $mobile_demo_button_title; ?></a>
                    </div>
				</div>
        ...
        <?php if ( empty($hide_powerful_block[0]) || 'yes' !== $hide_powerful_block[0] ) : ?>
		<div class="powerful">
			<div class="container">
				<div class="titleblock">
		...
		<div class="cta cta-vector">
			<div class="container">
				...
				<div class="buttons">
                    <a id="trial" href="<?php echo $trial_button_link; ?>" class="btnxl btnxl_white m-auto"><?php echo $trial_button_title; ?></a>
		...
		$action_signup_button_hide = get_field( 'action_signup_button_hide' );
		?>
		...
		<div class="cta">
			<div class="container">
				...
				<div class="buttons btngroup">
                    ...
                    <?php if ( empty($action_signup_button_hide[0]) || 'yes' !== $action_signup_button_hide[0] ) : ?>
